The app can be imported into an IDE e.g. IntelliJ Idea as a Maven project. It can then be built using mvn clean, install and then it should be possible to run it.
